...
public class Engine {
	/**
	 * tColores, un método public en el cual generamos el nombre de los colores
	 */
	...
	/**
	 * charToColor método que recibe por parametro un char _color
	 ...
	 * @param _numero parametro que recibe un número para converirlo en Color,
	 * @return
	 */
	...
	/**
	 * generarSecuencia, método que se encarga de generar un Array de colores aleatorios en el array secuenciaColores.
	 ...
	 * @param _menu Este metodo se encarga de generar el menú y recibir por consola un número que este redigira hacia donde lo haya indicado el usuario
	 */
	...
	/**
	 * Metodo helpMenu que se encarga de enseñar al usuario como jugar
	 */
	...
	/**
	 * Creacion del método start, metodo el cual recibe un nombre que llama a la clase Jugador
	 */
	  public void start() {
		  	Scanner scn = new Scanner(System.in);
			...
			mostrarMenu('0');
	  		...
	  		/**
	  		 * play, método que se encarga de llamar al método generarSecuencia y al método mostrarSecuencia que se encarga de recibir por consola los colores introducidos por el usuario
	  		 * 
	  		 */
			public void play() {
			  	Scanner scn = new Scanner(System.in);
